...
import CreateOrEditPromoCode from "../../../dialog/level/createOrEditLevel";
...
const PromoCodeTable = () => {
  ...
  const [columnDefs, setColumnDefs] = useState([
    { field: "courseID.courseName", headerName: "Course Name" },
